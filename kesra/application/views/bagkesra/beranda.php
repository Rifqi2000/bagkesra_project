...
<body>
    ...
    <section class="features" id="features">
            ...
            foreach ($bagkesra as $data) {
                if ($nomor == 0) { ?>
                    <div class='box-utama'>
                        ...
                        <h3><?php echo substr($data->judul_artikel, 0, 50), " ...";
                            ?></h3>
                        <p><?php echo substr($data->isi_artikel, 0, 220), " ..."; ?></p>
                        <a href='<?= base_url("bagkesra/artikel/" . $data->id_artikel) ?>' class='btn'>Selengkapnya</a>
                    </div>
                    <br>

                <?php $nomor++;
                } elseif ($nomor > 0 && $nomor < 4) { ?>
                    <div class='box'>
                        <img src="<?= base_url() ?>assets/img/uploads/<?= $data->foto_artikel; ?>" width="270px">
                        <h3><?php echo substr($data->judul_artikel, 0, 30), " ..."; ?></h3>
                        <a href='<?= base_url("bagkesra/artikel/" . $data->id_artikel) ?>' class='btn'>Selengkapnya</a>
                    </div>
                <?php $nomor++;
                } ?>
        ...
        <div class="all" align="center">
            ...
            <a href="<?= base_url("bagkesra/tampil_artikel/") ?>" class='btn'>Lebih Banyak</a>
        </div>
    </section>
    ...
    <section class="berita" id="berita">
        <div class='box-container'>
            <div class='box'>
                ...
                <iframe src="https://smartcity.semarangkota.go.id/public/rssberita/index.php" height="300px" width='100%' scrolling="yes" frameborder="0" content="upgrade-insecure-requests"></iframe>
            </div>
            <div class='box'>
                <h3>Jadwal Kegiatan</h3>
                <iframe src="https://webservice.infokegiatan.semarangkota.go.id/data.php" height="300px" width='100%' scrolling="yes" frameborder="0"></iframe>
            </div>
            <div class='box'>
                <h3>Twitter Hendi</h3>
